          ...
          <ul class="nav navbar-nav navbar-right">
              <?php
                  if(isset($_SESSION['user']))
                    {
                      echo'
                    <li><a href="library.php" class="btn btn-md"><span class="glyphicon glyphicon-shopping-cart">Library</span></a></li>
...
echo'                           <br><br><br>
                                <a id="buyLink" href="'.$target.'" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;"> 
                                    ADD TO Library for Rs '.$row["Price"] .' <br>
...
<div class="container-fluid" id="service">
      <div class="row">
          <div class="col-sm-6 col-md-3 text-center">
               ...
               CMM 007 <br>
                call us on 0120-3062244 or click here
          </div>
